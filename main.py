...
@app.route("/")
def hello_world():
    return f'<h1>Esta es una pagina de datos aleatorios</h1>  <a href="/random_fact">¡Ver un dato aleatorio!</a>'

@app.route("/random_fact")
def random_facts():
    return f'<h1>{random.choice(datos)}</h1>  <a href="/paginasecreta">¡Genera una contraseña al azar!</a>'

@app.route("/paginasecreta")
def paginasecreta():
    return f'<h1>{contraseña}</h1>'
